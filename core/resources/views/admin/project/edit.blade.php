    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <div class="">
                <div class="card-body">
                    <a  href="{{route('admin.sand.status.create', ['id' => $plan->id])}}" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> {{__('Status Update')}}</a>
                </div>
                </div>
            </div>
        </div>
                        ...
                        @csrf
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="customFileLang">{{__('Choose Media, Size Allowed (500 x 280)')}} *</label>
                                </div>
                            </div>   
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control select" name="period" data-fouc required>    
                                        <option value="Day" @if($plan->period=="Day"){{__('selected')}} @endif>{{__('Day - 1')}}</option>                                         
                                        <option value="Week" @if($plan->period=="Week"){{__('selected')}} @endif>{{__('Week - 7')}}</option>                                         
                                        <option value="Month" @if($plan->period=="Month"){{__('selected')}} @endif>{{__('Month - 30')}}</option>                                         
                                        <option value="Year" @if($plan->period=="Year"){{__('selected')}} @endif>{{__('Year - 365')}}</option>                                       
                                    </select>
                                    <span class="text-xs">This is the day investment will begin, you can only edit this if there are no investors</span>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <input type="text" step="any" name="interest" value="{{$plan->interest}}" class="form-control" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                    <div class="input-group">
                                        <input type="number" step="any" name="price" class="form-control" value="{{$plan->price}}" required>
                                        <span class="input-group-append">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-10">
                                        <input type="number" step="any" name="units" value="{{$plan->units}}" class="form-control" required>
                                        <span class="text-xs">This is the day investment will begin, you can only edit this if there are no investors</span>
                                </div>
                            </div>   
                            <div class="form-group row">
