                        ...
                        @if($set->language==1)
                            <div class="hs-unfold">
                                ...
                                data-hs-unfold-options='{
                                    ...
                                    <img class="dropdown-item-icon mr-2" src="{{url('/')}}/asset/images/flags/{{$dd->code}}.svg" alt="{{$dd->name}} SVG">
                                    <span class="d-none d-sm-inline-block">{{$dd->name}}</span>
                                </a>
                                <div id="languageDropdown" class="hs-unfold-content dropdown-menu">
                                @foreach($lang as $val)
                                    <a class="dropdown-item" href="{{url('/')}}/lang/{{$val->code}}"><img class="dropdown-item-icon" src="{{url('/')}}/asset/images/flags/{{$val->code}}.svg" alt="{{$val->name}} Flag">{{$val->name}}</a>
                                @endforeach
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="navbar-nav-wrap-content text-center">
                            <div class="d-none d-lg-block">
                                @if (Auth::guard('user')->check())
                                    <a href="{{route('user.dashboard')}}" class="btn btn-sm btn-primary transition-3d-hover">{{__('Dashboard')}}</a>
                                @else
                                    <a href="{{route('login')}}" class="btn btn-sm btn-light transition-3d-hover">{{__('Sign In')}}</a>
                                @endif
                            </div>
                        </div>
        ...
        <footer class="bg-light">
            <div class="container">
                        ...
                        <div class="col-lg-3 ml-lg-auto mb-5 mb-lg-0">
                            ...
                            @if($set->contact==1)
                                <ul class="nav nav-sm nav-x-0 flex-column mb-2">
                                    <li class="nav-item">
                                        <a class="nav-link media" target="_blank" href="https://www.google.com/maps/place/Sector+{{$set->address}}">
                                        <span class="media">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link media" href="mail:{{$set->email}}">
                                        <span class="media">
                ...
                <div class="space-1">
                    ...
                    <p class="opacity-75 small">&copy; {{$set->site_name}}. {{date('Y')}}. {{__('All rights reserved.')}}</p>
                    <p class="opacity-75 small">{{__('When you visit or interact with our sites, services or tools, we or our authorised service providers may use cookies for storing information to help provide you with a better, faster and safer experience and for marketing purposes.')}}</p>
                    </div>
                    <!-- End Copyright -->
                </div>
            </div>
