          ...
          <div class="form-group mb-3">
            ...
            <div class="text-center">
                ...
                @if($user->kyc_link!=null && $user->kyc_status==0)
                  <span class="error form-error-msg ">
                    <span class="badge badge-primary mb-3">{{__('Under review')}}</span>
                  </span>                    
                @elseif($user->kyc_link!=null && $user->kyc_status==1)
                  <span class="error form-error-msg ">
                    <span class="badge badge-success mb-3">{{__('Approved')}}</span>
                  </span>                
                @elseif($user->kyc_link==null && $user->kyc_status==2)
                  <span class="error form-error-msg ">
                    <span class="badge badge-primary mb-3">Declined: {{$user->kyc_reason}}</span>
                  </span>
                @endif
            </div>
        </form> 
