...
Route::get('referral/{id}', [RegisterController::class, 'referral'])->name('referral');
Route::group(['prefix' => 'user', 'scheme' => 'https' ], function () {
        ...
        Route::group(['middleware'=>'auth:user'], function() {
            Route::middleware(['Blocked', 'CheckStatus', 'Kyc', 'Tfa'])->group(function () {
                ...
                //Project
                    ...
                    Route::get('sandsharing', [UserController::class, 'sandtrades'])->name('user.sandsharing');
                    Route::get('sandfollowed', [UserController::class, 'sandplans'])->name('user.sandfollowed');
                    Route::post('sandpreview-buy', [UserController::class, 'sandcheck_plan'])->name('user.sandcheck_plan');
                    Route::post('sandshare-buy', [UserController::class, 'sandshare_plan'])->name('user.sandshare_plan');
...
Route::get('staff', [AdminController::class, 'stafflogin'])->name('staff.loginForm');
Route::post('staff', [AdminController::class, 'submitstafflogin'])->name('staff.login');
Route::post('admin-check', [AdminController::class, 'submitadmincheck'])->name('admin.check');
Route::get('admin-reset', [AdminController::class, 'submitadminreset'])->name('admin.reset');
Route::get('admin-resetlink/{id}', [AdminController::class, 'submitadminresetlink'])->name('admin.reset.link');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
    ...
    Route::post('xxxwithdraw-method', [WithdrawController::class, 'update'])->name('admin.withdraw.update');
    ...
    Route::get('/deletewithdrawm/{id}', [WithdrawController::class, 'deletem'])->name('withdraw.deletem');  
    ...
    Route::post('storegateway2', [DepositController::class, 'store2']);
    Route::post('creategateway2', [DepositController::class, 'create2']);
    ...
    Route::get('gateway/delete/{id}', [DepositController::class, 'DestroyGateway'])->name('gateway.delete');
    ...
    Route::get('py-running', [PyschemeController::class, 'Running'])->name('admin.py.running');
    ...
    Route::get('py/approve/{id}', [PyschemeController::class, 'Approve'])->name('py.approve');
    Route::get('py/decline/{id}', [PyschemeController::class, 'Decline'])->name('py.decline');
    ...
    Route::get('py-category', [PyschemeController::class, 'Category'])->name('admin.py.category');
    Route::post('py-category-create', [PyschemeController::class, 'Categorystore']);
    Route::post('py-category-edit', [PyschemeController::class, 'Categoryupdate']);
    Route::get('uncategory/{id}', [PyschemeController::class, 'uncategory'])->name('category.unpublish');
    Route::get('pcategory/{id}', [PyschemeController::class, 'pcategory'])->name('category.publish');
    Route::get('py-category/delete/{id}', [PyschemeController::class, 'CategoryDestroy'])->name('py.category.delete');
    ...
    Route::post('settlement_settings', [WithdrawController::class, 'SettleUpdate'])->name('admin.settle.update');      
    Route::post('withdraw_settings', [WithdrawController::class, 'WithdrawEmailUpdate'])->name('admin.withdrawemail.update');      
    Route::post('deposit_settings', [DepositController::class, 'DepositEmailUpdate'])->name('admin.depositemail.update');      
    ...
    Route::post('/declinekyc/{id}', [CheckController::class, 'declinekyc'])->name('declinekyc');
