  ...
  <div class="content-wrapper">
    <div class="card">
        <div class="card-header">
            ...
            <small>Only verified clients can recieve email address</small>
        </div>
        <div class="card-body">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/admin/user/promo.blade.php ENDPATH**/ ?>