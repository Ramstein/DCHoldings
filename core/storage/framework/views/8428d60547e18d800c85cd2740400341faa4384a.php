                                ...
                                <div class="modal-body p-0">
                                    ...
                                    <div class="card-body px-lg-5 py-lg-5">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-12">
                                                <input type="url" name="value" class="form-control" placeholder="link" value="<?php echo e($val->value); ?>">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/admin/web-control/social-links.blade.php ENDPATH**/ ?>