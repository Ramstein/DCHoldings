        ...
        <?php $__currentLoopData = $plan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="col-lg-4">
            <div class="pricing card-group flex-column flex-md-row mb-3">
              <div class="card card-pricing border-0 text-center mb-2 <?php if($val->popular==1): ?> bg-progress <?php endif; ?>">
                <div class="card-header bg-transparent">
                </div>
                <div class="card-body px-lg-7">
                  <h2 class="card-title mb-0 <?php if($val->popular==1): ?> text-white <?php endif; ?>" <?php if($val->popular==1): ?>title="Most popular" <?php endif; ?>><?php echo e($val->name); ?> <?php if($val->popular==1): ?> <i class="fal fa-star"></i> <?php endif; ?></h2>
                  ...
                  <br>
                  <a href="#" data-toggle="modal" data-target="#buy<?php echo e($val->id); ?>"  class="btn btn-block <?php if($val->popular==1): ?> btn-white <?php else: ?> btn-neutral <?php endif; ?>"><?php echo e(__('Purchase Plan')); ?></a>
                  <hr>
                  <?php
                            ...
                            <div class="card border-0 mb-0">
                              <div class="card-header bg-transparent pb-5">
                                ...
                                <div class="btn-wrapper text-center">
                                  <h1 class="text-uppercase text-future py-1 mb-0" id="profit<?php echo e($val->id); ?>"><?php echo e($val->name); ?></h1>
                                  <?php if($val->bonus!=null): ?>
                                    <p class="text-sm text-future mb-0" id="bonus<?php echo e($val->id); ?>"></p>
                                  <?php endif; ?>
                                    <p class="text-sm text-future mb-0">End by <?php echo e(date("Y/m/d h:i:A", strtotime($xndate))); ?></p>
                                </div>
                              </div>
                              <div class="card-body">
                                ...
                                <?php echo csrf_field(); ?> 
                                  ...
                                  <div class="form-group mb-3">
                                    <div class="input-slider-container<?php echo e($val->id); ?>">
                                      <div class="row mt-3">
                                        <div class="col-12 text-left">
                                          <input id="sliderValueInput<?php echo e($val->id); ?>" name="amount" type="hidden">
                                          ...
                                          <span id="input-slider-value<?php echo e($val->id); ?>" class="range-slider-value view<?php echo e($val->id); ?>" data-range-value-low="<?php echo e($val->min_deposit); ?>"></span>
                                        </div>
                                      </div>
                                      <div id="input-slider<?php echo e($val->id); ?>" class="input-slider source<?php echo e($val->id); ?>" data-range-value-min="<?php echo e($val->min_deposit); ?>" data-range-value-max="<?php echo e($val->amount); ?>"></div>
                                    </div> 
                                  </div> 
                                  <div class="form-group mb-3">
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/nn/core/resources/views/user/trading/plans.blade.php ENDPATH**/ ?>