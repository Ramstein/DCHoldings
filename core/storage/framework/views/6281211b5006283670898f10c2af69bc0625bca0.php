                      ...
                      <div class="col-6 text-right">
                        <?php if($val->claim==1): ?>
                          <?php if($val->status!=2): ?>
                            ...
                            <i class="fad fa-sync"></i> <?php echo e(__('History')); ?></a>
                            <a href="#" data-toggle="modal" data-target="#claim<?php echo e($val->id); ?>" class="btn btn-sm btn-neutral">
                            <i class="fad fa-smile"></i> <?php echo e(__('Claim Profit')); ?></a>
                          <?php endif; ?>
                        <?php endif; ?>
                      </div>
                    </div>
                      ...
                      <?php if($val->status!=2): ?>             
                        <div class="col-12">
                          <?php if($val->recurring==1): ?>
                            <?php if($val->c_r==1): ?>
                            <a href="<?php echo e(url('/')); ?>/user/cancel-recurring/<?php echo e($val->id); ?>" class="btn btn-sm btn-danger"><i class="fad fa-ban"></i> <?php echo e(__('Cancel Recurring')); ?></a>
                            <?php elseif($val->c_r==0): ?>
                            <a href="<?php echo e(url('/')); ?>/user/start-recurring/<?php echo e($val->id); ?>" class="btn btn-sm btn-success"><i class="fad fa-check"></i> <?php echo e(__('Start Recurring')); ?></a>
                            <?php endif; ?>
                          <?php endif; ?>
                          <a href="#" data-toggle="modal" data-target="#share<?php echo e($val->id); ?>" title="Share trading activity" class="btn btn-sm btn-neutral"><i class="fad fa-share"></i> <?php echo e(__('Share')); ?></a>
                        </div>   
                      <?php endif; ?>
                    </div>
                    <div class="row align-items-center"> 
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/kingsmen/new/core/resources/views/user/trading/trades.blade.php ENDPATH**/ ?>