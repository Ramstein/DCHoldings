            ...
            <?php echo csrf_field(); ?>
                <div class="form-group">
                  <div class="custom-file">
                    ...
                    <label class="custom-file-label" for="customFileLang"><?php echo e(__('Choose Media, Max: 500x500')); ?></label>
                  </div> 
                </div>              
              <div class="text-right">
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/user/profile/index.blade.php ENDPATH**/ ?>