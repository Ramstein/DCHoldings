                        ...
                        <table class="table table-flush" id="datatable-buttons">
                            ...
                            <?php $__currentLoopData = $profit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php echo e(date("Y/m/d hiA", strtotime($val->created_at))); ?></td>  
                                    <td><?php echo e(date("Y/m/d hiA", strtotime($val->updated_at))); ?></td>
                                    <td class="text-center">
                                        ...
                                        <?php if($val->status==1): ?>
                                            <a class='btn btn-sm btn-danger' href="<?php echo e(route('category.unpublish', ['id' => $val->id])); ?>"><i class="fad fa-ban"></i> <?php echo e(__('Disable')); ?></a>
                                        <?php else: ?>
                                            <a class='btn btn-sm btn-success' href="<?php echo e(route('category.publish', ['id' => $val->id])); ?>"><i class="fad fa-check"></i> <?php echo e(__('Enable')); ?></a>
                                        <?php endif; ?>
                                    </td>                   
                                </tr>
                                            ...
                                            <div class="modal-body p-0">
                                                <div class="card bg-white border-0 mb-0">
                                                    ...
                                                    <div class="card-body px-lg-5 py-lg-5 text-right">
                                                        ...
                                                        <a  href="<?php echo e(route('py.category.delete', ['id' => $val->id])); ?>" class="btn btn-danger btn-sm"><?php echo e(__('Proceed')); ?></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<div id="create" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo e(url('admin/py-category-create')); ?>" method="post">
            <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2"><?php echo e(__('Name')); ?></label>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/admin/investment/category.blade.php ENDPATH**/ ?>