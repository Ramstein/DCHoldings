                        ...
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="form-group">
                                <div class="custom-file">
                                    ...
                                    <label class="custom-file-label" for="customFileLang"><?php echo e(__('Choose Media (Only jpg, png files)')); ?></label>
                                </div>
                            </div>
                            <div class="form-group row">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/admin/project/create.blade.php ENDPATH**/ ?>