...
<div class="container-fluid mt--6">
    <div class="content-wrapper">
        <a href="<?php echo e(route('new.staff')); ?>" class="btn btn-sm btn-neutral mb-5"><i class="fad fa-plus"></i> <?php echo e(__('New Staff')); ?></a> 
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/admin/user/staff.blade.php ENDPATH**/ ?>