...
<div class="container-fluid mt--6">
    <div class="content-wrapper">
        <a data-toggle="modal" data-target="#new" href="" class="btn btn-sm btn-neutral mb-5"><i class="fad fa-plus"></i> <?php echo e(__('New Language')); ?></a> 
        <div class="modal fade" id="new" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
            <div class="modal-dialog modal- modal-dialog-centered modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="mb-0 h3"><?php echo e(__('Create Language')); ?></h3>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                <div class="modal-body">
                    <form action="<?php echo e(route('admin.store.language')); ?>" method="post">
                    <?php echo csrf_field(); ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="mb-0"><?php echo e(__('Language')); ?></h3>
                    </div>
                    <div class="table-responsive py-4">
                        <table class="table table-flush" id="datatable-buttons">
                            ...
                            <tbody>
                            <?php $__currentLoopData = $lang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e(++$k); ?>.</td>
                                    ...
                                    <td>
                                    <?php if($val->id!=1): ?>
                                        <a href="<?php echo e(route('admin.edit.language', ['id' => $val->id])); ?>" class="btn btn-success btn-sm"><?php echo e(__('Edit Keywords')); ?></a>
                                        <?php if($val->status==0): ?>
                                            <a class='btn btn-danger btn-sm' href="<?php echo e(route('language.block', ['id' => $val->id])); ?>"><?php echo e(__('Block')); ?></a>
                                        <?php else: ?>
                                            <a class='btn btn-success btn-sm' href="<?php echo e(route('language.unblock', ['id' => $val->id])); ?>"><?php echo e(__('Unblock')); ?></a>
                                        <?php endif; ?>
                                        <a data-toggle="modal" data-target="#delete<?php echo e($val->id); ?>" href="" class="btn btn-danger btn-sm"><?php echo e(__('Delete')); ?></a>
                                    <?php endif; ?>
                                    </td>                   
                                </tr>
                            ...
                            <div class="modal-body p-0">
                                <div class="card bg-white border-0 mb-0">
                                    ...
                                    <div class="card-body px-lg-5 py-lg-5 text-right">
                                        ...
                                        <a  href="<?php echo e(route('admin.delete.language', ['id' => $val->id])); ?>" class="btn btn-danger btn-sm"><?php echo e(__('Proceed')); ?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/admin/user/lang.blade.php ENDPATH**/ ?>