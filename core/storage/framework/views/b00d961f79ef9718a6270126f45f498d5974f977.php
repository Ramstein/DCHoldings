              ...
              <form role="form" action="<?php echo e(route('fund.submit')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="customFileLang"><?php echo e(__('Proof (Only jpg, png files)')); ?></label>
                    </div>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/user/fund/index.blade.php ENDPATH**/ ?>