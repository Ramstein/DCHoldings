...
<div class="container-fluid mt--6">
    <div class="content-wrapper">
        <div class="card">
            ...
            <div class="card-body">
                <form accept-charset="UTF-8" class="require-validation" data-cc-on-file="false"
                    data-stripe-publishable-key="<?php echo e($stripe['value1']); ?>" action="<?php echo e(route('ipn.stripe')); ?>" method="post"
                    id="payment-form">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" value="<?php echo e($stripe['track']); ?>" name="track">
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2"><?php echo e(__('Card Holder Name')); ?></label>
                        <div class="col-lg-10">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2"><?php echo e(__('Billing Address (USA Only)')); ?></label>
                        <div class="col-lg-10">
                            <div class="input-group input-group-merge">
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/user/payment/stripe.blade.php ENDPATH**/ ?>