        ...
        <form role="form" action="<?php echo e(route('user.upload-kyc')); ?>" enctype="multipart/form-data" method="post">
          ...
          <div class="form-group mb-3">
            <select class="form-control select" <?php if($user->kyc_link!=null && $user->kyc_status==0 || $user->kyc_link!=null && $user->kyc_status==1): ?> disabled <?php endif; ?> name="type" required>
              ...
              <option value="Passport" <?php if($user->kyc_type=='Passport'): ?> selected <?php endif; ?>><?php echo e(__('Passport')); ?></option>
            ...
            <?php endif; ?>            
            <div class="text-center">
                <?php if($user->kyc_link==null && $user->kyc_status==0 || $user->kyc_link==null && $user->kyc_status==2): ?>
                ...
                <?php if($user->kyc_link!=null && $user->kyc_status==0): ?>
                  <span class="error form-error-msg ">
                    <span class="badge badge-primary mb-3"><?php echo e(__('Under review')); ?></span>
                  </span>                    
                <?php elseif($user->kyc_link!=null && $user->kyc_status==1): ?>
                  <span class="error form-error-msg ">
                    <span class="badge badge-success mb-3"><?php echo e(__('Approved')); ?></span>
                  </span>                
                <?php elseif($user->kyc_link==null && $user->kyc_status==2): ?>
                  <span class="error form-error-msg ">
                    <span class="badge badge-primary mb-3">Declined: <?php echo e($user->kyc_reason); ?></span>
                  </span>
                <?php endif; ?>
            </div>
        </form> 
...
<?php echo $__env->make('loginlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/user/security/no-kyc.blade.php ENDPATH**/ ?>