...
<div class="container-fluid mt--6">
    ...
    <a data-toggle="modal" data-target="#create" href="" class="btn btn-sm btn-neutral ml-0 mb-3"><i class="fad fa-plus"></i> <?php echo e(__('Create service')); ?></a>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                                                ...
                                                <form action="<?php echo e(route('service.update')); ?>" method="post">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-lg-12"><?php echo e(__('Title')); ?></label>
                                                            <div class="col-lg-12">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/admin/web-control/service.blade.php ENDPATH**/ ?>