                                ...
                                <table class="table table-flush" id="datatable-buttons">
                                    ...
                                    <?php $__currentLoopData = $blog; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if($val->status==1): ?>
                                                    <span class="badge badge-success badge-pill"><?php echo e(__('Published')); ?></span>
                                                <?php else: ?>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/admin/blog/index.blade.php ENDPATH**/ ?>