      ...
      <div class="col-md-3">
        <div class="card">
          <div class="card-body">
            <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
              <div>
                <h3 class="card-title"><?php echo e(__('Standard Investment plans')); ?></h3>
                <ul class="list list-unstyled mb-0 text-sm">
      ...
      <div class="col-md-3">
        <div class="card">
          <div class="card-body">
            <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
              <div>
                <h3 class="card-title"><?php echo e(__('Standard Investment')); ?></h3>
                <ul class="list list-unstyled mb-0 text-sm">
                  <li><?php echo e(__('Active:')); ?> <span class="font-weight-semibold text-default">
      ...
      <div class="col-md-3">
        <div class="card">
          <div class="card-body">
            <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
              <div>
                <h3 class="card-title"><?php echo e(__('Project Investment plans')); ?></h3>
                <ul class="list list-unstyled mb-0 text-sm">
                  <li><?php echo e(__('Active:')); ?> <span class="font-weight-semibold text-default">
                    #<?php echo e($sappplan); ?></span></li>
                  <li><?php echo e(__('Disabled:')); ?> <span class="font-weight-semibold text-default">
                    #<?php echo e($spenplan); ?></span>
                  </li>              
                </ul>
              </div>
            </div>
      ...
      <div class="col-md-3">
        <div class="card">
          <div class="card-body">
            <div class="d-sm-flex align-item-sm-center flex-sm-nowrap">
              <div>
                <h3 class="card-title"><?php echo e(__('Project Investment')); ?></h3>
                <ul class="list list-unstyled mb-0 text-sm">
                  <li><?php echo e(__('Active:')); ?> <span class="font-weight-semibold text-default">
                    #<?php echo e($sappprofit); ?></span></li>
                  <li><?php echo e(__('Completed:')); ?> <span class="font-weight-semibold text-default">
                    #<?php echo e($spenprofit); ?></span>
                  </li>              
                </ul>
              </div>
            </div>
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\script\core\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>