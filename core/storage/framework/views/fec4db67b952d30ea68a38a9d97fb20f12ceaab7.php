        ...
        <footer class="bg-light">
            <div class="container">
                        ...
                        <div class="col-lg-3 ml-lg-auto mb-5 mb-lg-0">
                            ...
                            <?php if($set->contact==1): ?>
                                <ul class="nav nav-sm nav-x-0 flex-column mb-2">
                                    <li class="nav-item">
                                        <a class="nav-link media" target="_blank" href="https://www.google.com/maps/place/Sector+<?php echo e($set->address); ?>">
                                        <span class="media">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link media" href="mail:<?php echo e($set->email); ?>">
                                        <span class="media">
                ...
                <div class="space-1">
                    ...
                    <p class="opacity-75 small">&copy; <?php echo e($set->site_name); ?>. <?php echo e(date('Y')); ?>. <?php echo e(__('All rights reserved.')); ?></p>
                    <p class="opacity-75 small"><?php echo e(__('When you visit or interact with our sites, services or tools, we or our authorised service providers may use cookies for storing information to help provide you with a better, faster and safer experience and for marketing purposes.')); ?></p>
                    </div>
                    <!-- End Copyright -->
                </div>
            </div>
...
</html><?php /**PATH C:\xampp\htdocs\core\resources\views/layout.blade.php ENDPATH**/ ?>