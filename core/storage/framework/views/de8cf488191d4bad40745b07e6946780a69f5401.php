        ...
        <div class="col-md-8 col-lg-7 col-xl-6 offset-md-2 offset-lg-2 offset-xl-3 space-top-3 space-lg-0">
            ...
            <form role="form" action="<?php echo e(route('submitlogin')); ?>" method="post">
                ...
                <div class="js-form-message form-group">
                    ...
                    <input class="form-control" tabindex="1" placeholder="<?php echo e(__('Email address')); ?>" type="email"
                        name="email" aria-label="<?php echo e(__('Email address')); ?>" required
                    ...
                    <label class="input-label" for="signinSrPassword" tabindex="0">
                        <span class="d-flex justify-content-between align-items-center">
                            ...
                            <a class="link-underline text-capitalize font-weight-normal"
                                href="<?php echo e(route('user.password.request')); ?>">Forgot Password?</a>
                        </span>
                    </label>
                ...
                <div class="row align-items-center mb-5">
                    ...
                    <div class="col-sm-12">
                        <button type="submit"
                            class="btn btn-primary btn-block transition-3d-hover"><?php echo e(__('Login')); ?></button>
                    </div>
                </div>
                <!-- End Button -->
            </form>
...
<?php echo $__env->make('loginlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views//auth/login.blade.php ENDPATH**/ ?>