                            ...
                            <div id="receivetransfer">
                                <div class="form-group row">
                                    ...
                                    <select class="form-control select" name="type" id="upmin"  onkeyup="upmin()" required>
                                        <option value=""><?php echo e(__('Save From')); ?></option>
                                        <option value="1*<?php echo e($user->profit); ?>"><?php echo e(__('Profit')); ?> - <?php echo e($currency->symbol.number_format($user->profit)); ?></option>
                                        <option value="2*<?php echo e($user->balance); ?>"><?php echo e(__('Account balance')); ?> - <?php echo e($currency->symbol.number_format($user->balance)); ?></option>
                                        <option value="3*<?php echo e($user->ref_bonus); ?>"><?php echo e(__('Referral earnings')); ?> - <?php echo e($currency->symbol.number_format($user->ref_bonus)); ?></option>
                                    </select>
                                    </div>
                                </div> 
                                <div class="form-group row">
...
<?php echo $__env->make('frontlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/user/savings/new.blade.php ENDPATH**/ ?>