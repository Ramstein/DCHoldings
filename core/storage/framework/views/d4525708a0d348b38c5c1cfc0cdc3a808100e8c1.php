            ...
            <div class="card-body">
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <p class="text-sm text-dark mb-0"><?php echo e(__('Charge')); ?>: <?php echo e($val->charge); ?>%</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body px-lg-5 py-lg-5">
                  ...
                  <?php echo csrf_field(); ?>
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-success btn-block my-4"><?php echo e(__('Preview')); ?></button>
                    </div>
                  </form>
                </div>
              </div>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/nn/core/resources/views/user/fund/index.blade.php ENDPATH**/ ?>