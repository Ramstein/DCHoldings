    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <div class="">
                <div class="card-body">
                <a data-toggle="modal" data-target="#create" href="" class="btn btn-sm btn-neutral"><i class="fa fa-plus"></i> <?php echo e(__('Faq')); ?></a>
        ...
        <div class="row">
            <div class="col-md-12">
                                            ...
                                            <?php echo csrf_field(); ?>
                                                <div class="modal-body">
                                                    <div class="form-group row">
                                                        <div class="col-lg-12">
                                                            <input type="text" name="name" class="form-control" placeholder="Name" value="<?php echo e($val->name); ?>">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h3 class="mb-0 h4 text-dark font-weight-bolder"><?php echo e(__('Faq')); ?></h3>
                    </div>
                    <div class="table-responsive py-4">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <?php echo csrf_field(); ?>
                                                <div class="modal-body">
                                                    <div class="form-group row">
                                                        <div class="col-lg-12">
                                                            <input type="text" name="question" class="form-control" value="<?php echo e($val->question); ?>" placeholder="Question">
                                                            <input type="hidden" name="id" value="<?php echo e($val->id); ?>">
                                                        </div>
                                                    </div>  
                                                    <div class="form-group row">
                                                        <div class="col-lg-12">
                                                            <textarea type="text" name="answer" rows="4" class="form-control" placeholder="Answer"><?php echo e($val->answer); ?></textarea>
                                                        </div>
                                                    </div> 
                                                    <div class="form-group row">
                                                        <div class="col-lg-12">
            ...
            <div class="modal-content">
                ...
                <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <input type="text" name="question" class="form-control" placeholder="<?php echo e(__('Question')); ?>" required>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <div class="col-lg-12">
                                <textarea type="text" name="answer" rows="4" class="form-control" placeholder="<?php echo e(__('Answer')); ?>" ></textarea>
                            </div>
                        </div>  
                        <div class="form-group row">
                            <div class="col-lg-12">
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\core\resources\views/admin/web-control/faq.blade.php ENDPATH**/ ?>