    ...
    <div class="container space-top-3 space-top-lg-4 position-relative z-index-2">
        <div class="row justify-content-lg-between mb-5">
            <div class="col-md-6 col-lg-6">
                ...
                <div class="mb-3">
                    <a class="btn btn-primary btn-wide transition-3d-hover mb-2 mb-sm-0 mr-3"
                        href="<?php echo e(route('register')); ?>">Get Started</a>
                    <a class="btn btn-link mb-2 mb-sm-0" href="<?php echo e(route('contact')); ?>">Let's Talk <i
            ...
            <div class="row align-items-md-center">
                ...
                <div class="col-md-3 column-divider-md">
                    <div class="pl-md-2">
                        ...
                        <a class="font-size-1 font-weight-bold" href="<?php echo e(route('user.savings')); ?>"><?php echo e(__('Apply Now')); ?> <i
                                class="fal fa-angle-right fa-sm ml-1"></i></a>
                    </div>
                </div>
            </div>
        ...
        <div class="w-lg-100 mx-lg-auto position-relative">
            <div class="text-center">
                <ul class="nav nav-segment nav-pills scrollbar-horizontal mb-7" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php if($loop->first): ?> active <?php endif; ?>" id="pills-<?php echo e($val->id); ?>-code-features-tab"
                            data-toggle="pill" href="#pills-<?php echo e($val->id); ?>-code-features" role="tab"
                            aria-controls="pills-<?php echo e($val->id); ?>-code-features" aria-selected="true"><?php echo e($val->name); ?></a>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            <div class="tab-content pr-lg-4">
                <?php $__currentLoopData = $category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="tab-pane fade <?php if($loop->first): ?>show active <?php endif; ?>" id="pills-<?php echo e($val->id); ?>-code-features"
                    role="tabpanel" aria-labelledby="pills-<?php echo e($val->id); ?>-code-features-tab">
                    <div class="row position-relative z-index-2 mx-n2 mb-5 space-bottom-1">
                        <?php
                        $plan=App\Models\Plans::whereStatus(1)->wherecat_id($val->id)->orderBy('min_deposit',
                        'DESC')->paginate(6);
                        ?>
                        <?php if(count($plan)>0): ?>
                            ...
                            <div class="card h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="media font-size-1 mb-3">
                                        ...
                                        <div class="media-body">
                                            <?php echo e($currency->symbol.number_format($val->min_deposit)); ?>

                                            <?php echo e(__('Minimum Deposit')); ?>
                                    ...
                                    <div class="media font-size-1 mb-3">
                                        <i class="fal fa-check text-success mt-1 mr-2"></i>
                                        <div class="media-body">
                                            <?php if($val->ref_percent!=null): ?><?php echo e($val->ref_percent); ?>% <?php else: ?> <?php echo e(__('No')); ?>

                                            <?php endif; ?><?php echo e(__('Referral Bonus')); ?>
                                    ...
                                    <div class="media font-size-1 mb-3">
                                        <i class="fal fa-check text-success mt-1 mr-2"></i>
                                        <div class="media-body">
                                            <?php if($val->bonus!=null): ?><?php echo e($val->bonus); ?>% <?php else: ?> <?php echo e(__('No')); ?>

                                            <?php endif; ?><?php echo e(__('Investment Bonus')); ?>
                                    ...
                                    <div class="media font-size-1 mb-3">
                                        <i class="fal fa-check text-success mt-1 mr-2"></i>
                                        <div class="media-body">
                                            <?php if($val->claim==1): ?> <?php echo e(__('Access to Profit anytime')); ?> <?php else: ?>
                                            <?php echo e(__('Access to profit at end of plan')); ?> <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="media font-size-1 mb-3">
                                        <i class="fal fa-check text-success mt-1 mr-2"></i>
                                        <div class="media-body">
                                            <?php if($val->recurring==1): ?> <?php echo e(__('Recurring capital investment')); ?> <?php else: ?>
                                            <?php echo e(__('No recurring capital investment')); ?> <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer border-0">
                                    <a href="<?php echo e(route('register')); ?>"
                                        class="btn btn-soft-primary btn-block transition-3d-hover"><?php echo e(__('Get Started')); ?></a>
                                </div>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="container-xl container-fluid space-1 space-md-2 px-4 px-md-8 px-lg-10">
        <div class="px-3">
            ...
            <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5 mb-md-9">
                <span
                    class="d-block small text-light font-weight-bold text-cap mb-2"><?php echo e(__('INVEST IN COMPANIES')); ?></span>
                <h2 class="text-light"><?php echo e(__('See how')); ?> <?php echo e($set->site_name); ?>

                    <?php echo e(__('is helping people get organized and work smarter')); ?></h2>
            </div>
            <!-- End Title -->
            <!-- Nav -->
            <div class="text-center">
                            ...
                            <a href="<?php echo e(route('check.plan', ['id' => $val->slug])); ?>">
                                <div class="card h-100">
                                    <div class="card-body">
                                        ...
                                        <small class="card-text"><span class="text-success"><?php echo e($val->interest); ?>%</span>
                                            <?php echo e(__('Returns in')); ?> <?php echo e($val->duration.' '.$val->period); ?></small>
                                        <small class="card-text"><span
                                                class="text-success"><?php echo e($currency->symbol.$val->price); ?></span>
                                            <?php echo e(__('per Unit')); ?></small>
                                    </div>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="card-footer border-0 bg-transparent pt-0 px-5 pb-5">
                        <div class="media align-items-center">
                            <div class="avatar avatar-circle mr-3">
                                <img class="avatar-img" src="<?php echo e(url('/')); ?>/asset/review/<?php echo e($val->image_link); ?>"
                                    alt="Image Description">
                            </div>
                            <div class="media-body">
    ...
    <div class="row justify-content-lg-center">
        <div class="col-md-4 mb-7 mb-lg-0">
            <div data-aos="fade-up" data-aos-delay="100" class="aos-init aos-animate">
                ...
                <div class="text-center px-md-3 px-lg-7">
                    <figure class="mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 71.7 64" width="71"
                            height="64">
                            <path fill="#FFC107"
                    ...
                    <span class="text-dark font-weight-bold"><?php echo e($currency->symbol.number_format($t_profit)); ?></span>
                    <p class="mb-0"><?php echo e(__('Profit Shared')); ?></p>
                </div>
                <!-- End Stats -->
            </div>
        </div>
                    ...
                    <figure class="mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 71.7 64" width="71"
                            ...
                            <g transform="matrix(1 0 0 1 0 1.907349e-06)" style="clip-path:url(#SVGID_2_);">
                                <image width="100" height="100" xlink:href="<?php echo e(url('/')); ?>/asset/images/img9.jpg"
                                    transform="matrix(0.36 0 0 0.36 32.8571 25.1429)"></image>
                            </g>
                            ...
                            <g style="clip-path:url(#SVGID_4_);">
                                <image width="100" height="100" xlink:href="<?php echo e(url('/')); ?>/asset/images/img3.jpg"
                                    transform="matrix(0.36 0 0 0.36 16.5714 2.8571)"></image>
                            </g>
                            ...
                            <g style="clip-path:url(#SVGID_6_);">
                                <image width="100" height="100" xlink:href="<?php echo e(url('/')); ?>/asset/images/img8.jpg"
                                    transform="matrix(0.3771 0 0 0.3771 2 24.2857)"></image>
                            </g>
                            <use xlink:href="#SVGID_5_" fill="none" stroke="#FFFFFF" stroke-width="4"></use>
                        </svg>
                    </figure>
                    <span class="text-dark font-weight-bold"><?php echo e($currency->symbol.number_format($t_amount)); ?></span>
                    <p class=" mb-0"><?php echo e(__('Money invested')); ?></p>
                </div>
                <!-- End Stats -->
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div data-aos="fade-up" data-aos-delay="100" class="aos-init aos-animate">
                ...
                <div class="text-center column-divider-md column-divider-20deg px-md-3 px-lg-7">
                    <figure class="mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="71" height="64"
                            viewBox="0 0 71.7 64">
                      ...
                      L47.9,1.3z"></path>
                            ...
                            <line fill="none" stroke="#0b30d8" stroke-width="2" stroke-linecap="round" x1="48.2" y1="21"
                                x2="28" y2="21"></line>
                            <line fill="none" stroke="#0b30d8" stroke-width="2" stroke-linecap="round" x1="48.2"
                                y1="27.9" x2="28" y2="27.9"></line>
                            <line fill="none" stroke="#0b30d8" stroke-width="2" stroke-linecap="round" x1="48.2"
                                y1="34.8" x2="28" y2="34.8"></line>
                            <line fill="none" stroke="#0b30d8" stroke-width="2" stroke-linecap="round" x1="48.2" y1="42"
                                x2="28" y2="42"></line>
                    ...
                    <span class="text-dark font-weight-bold"><?php echo e($currency->symbol.number_format($t_payout)); ?></span>
                    <p class=" mb-0"><?php echo e(__('Payouts processed')); ?></p>
                </div>
                <!-- End Stats -->
            </div>
        </div>
...
<div class="container space-2">
    ...
    <!-- Team Carousel -->
    <div class="js-slick-carousel slick slick-gutters-3 mb-5 mb-lg-3" data-hs-slick-carousel-options='{
                        "slidesToShow": 4,
                        "dots": true,
        ...
        <div class="js-slide pb-6">
            <!-- Team -->
            <img class="img-fluid w-100 rounded" src="<?php echo e(url('/')); ?>/asset/review/<?php echo e($val->image); ?>"
                alt="Image Description">
