...
<div class="container-fluid mt--6">
  <div class="content-wrapper">
    <a data-toggle="modal" data-target="#modal-formx" href="" class="btn btn-sm btn-neutral mb-5"><i class="fal fa-plus"></i> <?php echo e(__('Withdraw request')); ?></a>
    <div class="row">
      <div class="col-md-12">
                  ...
                  <div class="form-group row">
                    <div class="col-lg-12">
                      <select class="form-control select" name="type" required>
                        ...
                        <option value="1"><?php echo e(__('Trading profit')); ?> - <?php echo e($currency->symbol.number_format($user->profit)); ?></option>
                ...
                <div class="card" style="background-color:<?php echo e($set->d_c); ?>;">
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <p class="text-sm text-dark mb-0"><?php echo e(__('Amount')); ?>: <?php echo e(number_format($val->amount).$currency->name); ?></p>
                        <p class="text-sm text-dark mb-0"><?php echo e(__('Charge')); ?>: <?php echo e(number_format($val->charge).$currency->name); ?></p>
...
<?php echo $__env->make('userlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/nn/core/resources/views/user/profile/withdraw.blade.php ENDPATH**/ ?>